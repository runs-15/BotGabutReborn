...
class Presensi(Cog):
    def __init__(self, bot):
        ...
        #get day scheduler
        self.scheduler.add_job(self.get_day, CronTrigger(hour=16, minute=2, day_of_week="mon-fri", timezone="Asia/Jakarta"))
    ...
    async def presensi_pagi(self):
        ...
        if pause_datang > 0:
            ...
            for j in [i for i in db.servers_con['servers']['server'].find()]:
                channel = self.bot.get_channel(j['presensi_channel'])
